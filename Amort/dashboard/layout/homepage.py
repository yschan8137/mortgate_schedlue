...
controls = dbc.Card(
    [
        ...
        # Payment Methods
        refreshable_dropdown(label='Payment methods', id=ids.LOAN.PAYMENT_OPTIONS,
                             id_for_refreshment=ids.LOAN.REFRESH_ALL_OPTIONS),
                            ...
                            dbc.CardBody(
                                [
                                    ...
                                    refreshable_dropdown(
                                        label='Payment method', id=ids.LOAN.SUBSIDY.METHOD, id_for_refreshment=ids.LOAN.SUBSIDY.REFRESH_ALL_OPTIONS)
                                ]
                            ),
                        ],
                        className="mb-3",
