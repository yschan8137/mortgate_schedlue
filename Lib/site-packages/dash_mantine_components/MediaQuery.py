...
"""
    ...
    _type = 'MediaQuery'
    @_explicitize_args
    def __init__(self, children=None, smallerThan=Component.UNDEFINED, largerThan=Component.UNDEFINED, query=Component.UNDEFINED, styles=Component.REQUIRED, **kwargs):
        self._prop_names = ['children', 'largerThan', 'query', 'smallerThan', 'styles']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'largerThan', 'query', 'smallerThan', 'styles']
